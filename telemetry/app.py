...
# Inline services (avoid import issues under fastapi run app.py)
...
def poll_devin_sessions(sessions: list[dict], api_key: str = "") -> list[dict]:
    ...
    for s in sessions:
        ...
        try:
            ...
            resp = requests.get(
                f"https://api.devin.ai/v1/sessions/{clean_sid}",
...
# still import these pure utilities from local files
try:
